...
rem ::: !!! Black screen can occur if used with settings that activate DSC !!!
rem ::: !!! NVIDIA GPUS only !!!
...
rem ::: Keeping this key here if ever wanting to disable (0)
...
rem ::: Enable Old NVIDIA Sharpening Filter
