...
rem ::: 0x28 Hex 40 Decimal = Short/Fixed/0 93.75ms/93.75ms/281.25ms (Theoretical highest potential for best performance balance.)
...
rem ::: 0x2A Hex 42 Decimal = Short/Fixed/2 93.75ms/93.75ms/281.25ms (Theoretical highest potential for lowest latency.)
